...
class FermentasiKeringPage extends StatefulWidget {
  @override
  _FermentasiKeringPageState createState() => _FermentasiKeringPageState();
}

class _FermentasiKeringPageState extends State<FermentasiKeringPage> {
  ...
  Future<List<dynamic>> _fetchDataUsers() async {
    var result = await http.get(Uri.parse(Connection.buildUrl(
        '/pasca/fermentasi_kering'))); // Menggunakan Connection.buildUrl()

...
// class FermentasiMekanisPage extends StatefulWidget {
//   @override
//   _FermentasiMekanisPageState createState() => _FermentasiMekanisPageState();
// }

// class _FermentasiMekanisPageState extends State<FermentasiMekanisPage> {
...
class _FermentasiMekanisPageState extends State<FermentasiMekanisPage> {
  ...
  Future<List<dynamic>> _fetchDataUsers() async {
    var result = await http.get(Uri.parse(Connection.buildUrl(
        '/pasca/fermentasi_mekanis'))); // Menggunakan Connection.buildUrl()
    return json.decode(result.body);
  }

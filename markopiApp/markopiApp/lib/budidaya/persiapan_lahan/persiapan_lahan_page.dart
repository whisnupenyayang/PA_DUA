...
import 'dart:convert';
import 'detail_persiapan_lahan_page.dart';
import 'package:belajar_flutter/connection.dart'; // Import file connection.dart

class PersiapanLahanPage extends StatefulWidget {
  @override
  _PersiapanLahanPageState createState() => _PersiapanLahanPageState();
}

class _PersiapanLahanPageState extends State<PersiapanLahanPage> {
  ...
  Future<List<dynamic>> _fetchDataUsers() async {
    var result = await http.get(Uri.parse(Connection.buildUrl(
        '/budidaya/persiapan_lahan'))); // Menggunakan Connection.buildUrl()
                            ...
                            ListTile(
                              onTap: () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        DetailPersiapanLahanPage(data: data),
                                  ),
                                );
                              },
                              leading: ClipRRect(

...
import 'dart:convert';
import 'detail_pemilihan_lahan_page.dart';
import 'package:belajar_flutter/connection.dart'; // Import file connection.dart

class PemilihanLahanPage extends StatefulWidget {
  @override
  _PemilihanLahanPageState createState() => _PemilihanLahanPageState();
}

class _PemilihanLahanPageState extends State<PemilihanLahanPage> {
  ...
  Future<List<dynamic>> _fetchDataUsers() async {
    var result = await http.get(Uri.parse(Connection.buildUrl(
        '/budidaya/pemilihan_lahan'))); // Menggunakan Connection.buildUrl()

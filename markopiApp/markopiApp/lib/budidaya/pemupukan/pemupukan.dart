...
class PemupukanPage extends StatefulWidget {
  @override
  _PemupukanPageState createState() => _PemupukanPageState();
}

class _PemupukanPageState extends State<PemupukanPage> {
  ...
  Future<List<dynamic>> _fetchDataUsers() async {
    var result = await http.get(Uri.parse(Connection.buildUrl(
        '/budidaya/pemupukan'))); // Menggunakan Connection.buildUrl()

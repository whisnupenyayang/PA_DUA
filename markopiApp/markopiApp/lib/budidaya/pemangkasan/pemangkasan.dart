...
import 'dart:convert';
import 'detail_pemangkasan.dart';
import 'package:belajar_flutter/connection.dart'; // Import file connection.dart

class PemangkasanPage extends StatefulWidget {
  @override
  _PemangkasanPageState createState() => _PemangkasanPageState();
}

class _PemangkasanPageState extends State<PemangkasanPage> {
  ...
  Future<List<dynamic>> _fetchDataUsers() async {
    var result = await http.get(Uri.parse(Connection.buildUrl(
        '/budidaya/pemangkasan'))); // Menggunakan Connection.buildUrl()

...
import 'dart:convert';
import 'detail_kesesuaian_lahan_page.dart';
import 'package:belajar_flutter/connection.dart'; // Import file connection.dart

class KesesuaianLahanPage extends StatefulWidget {
  @override
  _KesesuaianLahanPageState createState() => _KesesuaianLahanPageState();
}

class _KesesuaianLahanPageState extends State<KesesuaianLahanPage> {
  ...
  Future<List<dynamic>> _fetchDataUsers() async {
    var result = await http.get(Uri.parse(Connection.buildUrl(
        '/budidaya/kesesuaian_lahan'))); // Menggunakan Connection.buildUrl()

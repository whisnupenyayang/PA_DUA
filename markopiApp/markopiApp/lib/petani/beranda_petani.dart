...
class BerandaPetani extends StatefulWidget {
  @override
  _BerandaPetaniState createState() => _BerandaPetaniState();
}

class _BerandaPetaniState extends State<BerandaPetani> {
  int? userId;
  String? currentDate;
